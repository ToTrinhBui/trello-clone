    ...
    return (
        <div className="sidebar" style={style} {...props}>
            <div className="sidebar-inner">
                <div className="part">
                    <div className="title">
                        <div className="logo"><h1>T</h1></div>
                ...
                <div className="part">
                    ...
                    <div style={{ position: 'relative' }}>
                        <div className="option btn" onClick={toggle}>
